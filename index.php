...
<body>
    <a href="#" class="btn-flotante" id="btnCarrito" style="background-color: blue">Carrito <span class="badge bg-success" id="carrito">0</span></a>
    <!-- Navigation-->
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Cat&aacute;logo</a>
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">GAME ZONE</h1>
            </div>
        </div>
    </header>
    ...
    <footer class="py-5 bg-dark">
        <div class="container">
            <p class="m-0 text-center text-white">GAME ZONE 2023</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
